...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Groups(['read_Forum', 'read_Comment', 'read_Media', 'read_Clip', 'read_Tournament', 'getc_article'])]
    private ?Uuid $id = null;
    
    #[ORM\Column(length: 180, unique: true)]
    #[Asserts\NotBlank()]
    #[Groups(['get_user', 'write_user', 'getc_user','update_user','read_Forum', 'read_Comment', 'read_Media', 'read_Clip', 'read_Tournament', 'getc_article'])]
