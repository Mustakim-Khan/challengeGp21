...
class ForumUserListener implements EventSubscriberInterface{
    ...
    public function setOwner(ViewEvent $event){
        ...
        if($article instanceof Article && (Request::METHOD_POST === $method || Request::METHOD_PATCH === $method || Request::METHOD_PUT === $method)){
